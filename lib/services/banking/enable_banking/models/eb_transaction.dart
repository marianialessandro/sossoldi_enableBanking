...
class EbTransaction {
  ...
  const EbTransaction({this.entryReference, this.transactionId, required this.status, this.bookingDate, this.valueDate, this.transactionDate, required this.transactionAmount, required this.creditDebitIndicator, this.creditorName, this.debtorName, this.remittanceInformation = const [], this.note});
  ...
  static EbTransaction fromJson(Map<String, dynamic> json) => EbTransaction(
    ...
    transactionAmount: EbAmount.fromJson(json['transaction_amount'] as Map<String, dynamic>),
    creditDebitIndicator: json['credit_debit_indicator'] as String,
    creditorName: (json['creditor'] as Map<String, dynamic>?)?['name'] as String?,
    debtorName: (json['debtor'] as Map<String, dynamic>?)?['name'] as String?,
    remittanceInformation: ((json['remittance_information'] as List?) ?? const []).map((e) => e as String).toList(),
